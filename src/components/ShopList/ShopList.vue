    ...
    <div class="shop_container">
            <ul class="shop_list" v-if="shops.length>0">
              <li class="shop_li border-1px" v-for="(shop,index) in shops" :key="index" @click="$router.push('/shop')">
                <a>
                  <div class="shop_left">
                    <img class="shop_img" src="https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fb-ssl.duitang.com%2Fuploads%2Fitem%2F201804%2F21%2F20180421095642_vmclv.jpg&refer=http%3A%2F%2Fb-ssl.duitang.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1614006139&t=c2f85ddf2cb543d5d33fb619dbf2c82c">
                  </div>
            ...
            <ul v-for="item in 6" :key="item" v-else>
              <li>
...
export default {
    data() {
      return {
        baseImageUrl: 'http://cangdu.org:8002/img/',
      }
    },
